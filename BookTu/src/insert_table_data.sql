...
insert into Book values(1,2,"数学建模","姜启源","数学建模比赛专用",20,0,"机械工业出版社");
insert into Book values(2,1,"世间万物","艾米·里奇","动物相遇",30,0,"南京大学出版社");
insert into Book values(3,4,"一个人生活","谷川俊太郎","日本著名诗人谷川俊太郎年近古稀时的作品",20,0,"湖南文艺出版社");
insert into Book values(4,3,"皮肤的秘密","[德]耶尔•阿德勒","关于人体最大器官的一切",40,0,"东方出版社");
insert into Book values(5,5,"建筑师","艾琦","如果人生是一张建筑图纸,属于你的那栋房屋会是什么模样？",35,0,"北京联合出版公司");
