...
insert into Book values(1,2,"数学建模","姜启源","数学建模比赛专用",20,"机械工业出版社","算法"," ",69.00,425,9787111277293);
insert into Book values(2,1,"世间万物","艾米·里奇","动物相遇",30,"南京大学出版社","教育","精装",58.00,212,9787305213410);
insert into Book values(3,4,"一个人生活","谷川俊太郎","日本著名诗人谷川俊太郎年近古稀时的作品",20,"湖南文艺出版社","日本文学"," ",45.00,272,9787540488789);
insert into Book values(4,3,"皮肤的秘密","[德]耶尔•阿德勒","关于人体最大器官的一切",40,"东方出版社","健康","平装",59.00,312,9787520705134);
insert into Book values(5,5,"建筑师","艾琦","如果人生是一张建筑图纸,属于你的那栋房屋会是什么模样？",35,"北京联合出版公司","励志","精装",198.00,344,9787559620590);
